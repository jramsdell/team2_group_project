...
public class filterpartial {
    ...
    public static ArrayList<String> readfilespamfull() throws IOException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("/Users/abnv/Desktop/trec07p/partial/index"));
...
//        }
    ...
    public static ArrayList<String> readfilehamfull() throws IOException {
        ...
        BufferedReader br1 = new BufferedReader(new FileReader("/Users/abnv/Desktop/trec07p/partial/index"));
